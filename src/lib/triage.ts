...
export const STANDARD_SUBSIDIES: { name: string; use: string }[] = [
  { name: "IT導入補助金", use: "ソフト・システム・ECなどのIT導入" },
  { name: "小規模事業者持続化補助金", use: "広告・販路開拓・店舗改装など" },
  { name: "ものづくり補助金", use: "設備投資・試作開発・生産性向上" },
  { name: "中小企業省力化投資補助金", use: "省人化・自動化の設備導入" },
  { name: "事業承継・M&A補助金", use: "事業承継・引き継ぎ・M&A" },
  { name: "業務改善助成金", use: "賃上げと設備投資をセットで" },
  { name: "キャリアアップ助成金", use: "正社員化・処遇改善（雇用系）" },
  { name: "省エネ設備導入補助金", use: "空調・LED・高効率機器など" },
];
