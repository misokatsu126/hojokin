...
// 例文は「支出の内容そのもの」を表す、業種に依存しない中立な表現にする
export const TEMPLATE_EXAMPLES: Record<string, string[]> = {
  aircon: ["業務用エアコンの入れ替え", "事務所・店舗の空調更新", "省エネ型エアコンの導入"],
  renovation: ["内装のリニューアル", "外装・ファサードの改修", "レイアウト変更・間仕切り"],
  signboard: ["建物・店舗の看板設置", "案内サイン・誘導表示", "袖看板・スタンド看板"],
  website: ["コーポレートサイト制作", "商品・サービスの紹介LP", "サイトのリニューアル"],
  ec: ["ネットショップの新規構築", "通販・お取り寄せの開始", "受発注のオンライン化"],
  ai_pos: ["POS・レジの導入", "在庫管理システムの導入", "AIによる需要予測・分析"],
  ad: ["SNS・Web広告の出稿", "チラシ・DMの作成配布", "キャンペーンの宣伝"],
  event: ["展示会・見本市への出展", "自社イベント・体験会", "セミナー・商談会の開催"],
  hire: ["正社員の新規採用", "非正規から正社員への転換", "高齢者・障害者の雇用"],
  training: ["新人・OJT研修", "デジタル・DXのリスキリング", "資格取得・技能研修"],
  energy: ["照明のLED化", "高効率機器への更新", "冷蔵・空調の省エネ化"],
  newstore: ["新規出店・開業", "2拠点目の出店", "空き物件の活用"],
  machinery: ["加工機・製造機械の導入", "検査・測定機器の導入", "包装・梱包機の導入"],
  vehicle: ["配送・営業用の車両", "移動販売車（キッチンカー）", "フォークリフト・運搬機"],
  system: ["受発注・基幹システム", "予約・顧客管理(CRM)", "会計・勤怠・労務システム"],
  hygiene: ["衛生設備・改修(HACCP対応)", "手洗い・換気の整備", "間仕切り・感染対策"],
  bcp: ["自家発電・蓄電設備", "耐震・防災対策", "事業継続(BCP)計画づくり"],
  export: ["海外展示会・商談会", "越境EC・海外販売", "資料・サイトの多言語化"],
  certification: ["ISO等の認証取得", "特許・実用新案の出願", "商標・意匠の登録"],
  inbound: ["多言語メニュー・サイト", "キャッシュレス・Wi-Fi整備", "訪日客向けの販促"],
  new_business: ["新サービス・新事業の立ち上げ", "新分野・異業種への進出", "新しい販売方法への転換"],
  succession: ["後継者への引き継ぎ準備", "M&A・事業譲渡", "承継後の設備投資"],
  wage: ["賃上げに合わせた設備投資", "最低賃金引き上げへの対応", "省力化で生産性アップ"],
  labor_saving: ["作業の自動化・機械化", "受付・予約の無人化", "在庫・検品の効率化"],
  ai: ["生成AIで業務効率化", "AIチャットボットの導入", "AIで予測・検査・分析"],
  product_dev: ["新商品・新メニューの試作", "新しい仕様・レシピの開発", "パッケージ・ブランド開発"],
  decarbon: ["太陽光・蓄電池の導入", "EV・充電設備の導入", "高効率設備への更新"],
  startup: ["これからの起業・開業", "個人事業・フリーランスの開業", "会社設立・法人化"],
  workstyle: ["勤怠・労務システムの導入", "休暇・時短など制度づくり", "残業削減の環境整備"],
};
